              ...
              <div className="chat-main-header-identity">
                ...
                <div>
                  ...
                  {selectedChat.campaignTitle && (
                    <div className="chat-campaign-badge" style={{ fontSize: '0.75rem', color: 'var(--clr-primary)', fontWeight: 600, background: 'rgba(99, 102, 241, 0.1)', padding: '0.1rem 0.6rem', borderRadius: '10px', marginTop: '2px', display: 'inline-block' }}>
                      Campaign: {selectedChat.campaignTitle}
                    </div>
                  )}
                </div>
              </div>
